...
<main class="container">
    <h1>Resultado para: palavra pesquisada</h1>
    ...
    <div class="cont-result-category">
        ...
        <div class="container-receitas">
            ...
            <div class="cont-item-receitas">
                <!-- Imagem da receita -->
                <img src="../img-receita.jpg" alt="Imagem da receita" class="box-img-receita">
                <!-- Receitas e comentários-->
                <div class="box-receitas">
                    <!-- Receita -->
                    <div class="cont-receita">
                        <h4>Nome da receita</h4>
                        <p>Categoria: Nome da Categoria</p>
                        <p>By: Nome de quem incluiu a receita</p>
                        <div class="interacao">
                            <!-- Curtida -->
                            <div>
                                <button>
